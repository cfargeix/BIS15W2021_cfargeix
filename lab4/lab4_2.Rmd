...
```{r}
mammals_again <- select(mammals, "genus", "mass", "gestation", "newborn",)
mammals_again
```

```{r}
mammals_again <- filter(mammals_again, genus %in% c("Lophocebus", "Erythrocebus", "Macaca"))
mammals_again
```
