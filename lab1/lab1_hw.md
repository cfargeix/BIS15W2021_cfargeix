...
R is a programming language and RStudio (a GUI) is the interface which allows programmers to code with R. GitHub is a tool that allows coders to upload and share their code with anyone. It's useful for collaboration.
